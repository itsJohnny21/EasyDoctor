...
SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMN_PRIVILEGES WHERE PRIVILEGE_TYPE = 'SELECT' AND TABLE_NAME = 'users' AND GRANTEE = "'neutral'@'%'";
...
GRANT SELECT (ID, creationTime, userID, doctorID, drugID, intakeDay, intakeTime, dosageQuantity, dosageUnits, description) ON prescriptions TO 'doctor'@'%';
GRANT SELECT (ID, creationTime, userID, doctorID, drugID, intakeDay, intakeTime, dosageQuantity, dosageUnits, description) ON prescriptions TO 'nurse'@'%';
GRANT UPDATE (ID, name, manufacturer, shelfLife, instructions, description, sideEffects, storageInformation, activeIngredients) ON drugs TO 'doctor'@'%';
GRANT SELECT (ID, name, manufacturer, shelfLife, instructions, description, sideEffects, storageInformation, activeIngredients) ON drugs TO 'doctor'@'%';
GRANT SELECT (ID, name, manufacturer, shelfLife, instructions, description, sideEffects, storageInformation, activeIngredients) ON drugs TO 'nurse'@'%';
GRANT DELETE ON prescriptions TO 'doctor'@'%';
GRANT DELETE ON drugs TO 'doctor'@'%';
GRANT SELECT (ID, name, address, phone, email) ON pharmacies TO 'doctor'@'%';
GRANT SELECT (ID, name, address, phone, email) ON pharmacies TO 'nurse'@'%';
GRANT SELECT (ID, name, address, phone, email) ON pharmacies TO 'patient'@'%';
GRANT SELECT (ID, name, address, phone, email) ON pharmacies TO 'doctor'@'%';
GRANT SELECT (ID, name, address, phone, email) ON pharmacies TO 'nurse'@'%';
GRANT SELECT (ID, name, address, phone, email) ON pharmacies TO 'patient'@'%';
GRANT SELECT (ID, name, phone, email) ON insuranceProviders TO 'doctor'@'%';
GRANT SELECT (ID, name, phone, email) ON insuranceProviders TO 'nurse'@'%';
GRANT SELECT (ID, name, phone, email) ON insuranceProviders TO 'patient'@'%';
use easydoctor;

...
public class TableBuilder {
	...
	public static class TableData {
		...
		public TableData(String originalName, String name, String[] originalHeader, String[] header,
				ArrayList<String[]> originalRows, ArrayList<String[]> rows) throws Exception {
	...
	public static class Table extends GridPane {
		...
		public Table(TableData data, double rowWidth, double rowHeight, String style, String rowStyle,
				boolean displayTableNameOption, boolean displayHeaderOption, boolean scrollableOption,
				Consumer<Row> selectAction) {
			super();
	...
	public static Form generateContactInformationFormFor(int userID, String tableName, double rowWidth,
			double rowHeight, String style, String fieldStyle) throws Exception {
	...
	public static Form generateMedicalInformationFormFor(int userID, String tableName, double rowWidth,
			double rowHeight, String style, String fieldStyle) throws Exception {
	...
	public static Table generateHealthConditionsTableFor(int userID, String tableAlias, double rowWidth,
			double rowHeight, String style, String rowStyle) throws Exception {
	...
	public static Table generateVaccineRecordFor(int userID, String tableAlias, double rowWidth, double rowHeight,
			String style, String rowStyle) throws Exception {
	...
	public static Table generateAllergiesTableFor(int userID, String tableAlias, double rowWidth, double rowHeight,
			String style, String rowStyle) throws Exception {
	...
	public static Table generateSurgeriesTableFor(int userID, String tableAlias, double rowWidth, double rowHeight,
			String style, String rowStyle) throws Exception {
	...
	public static Table generateVisitsTableFor(int userID, String tableAlias, double rowWidth, double rowHeight,
			String style, String rowStyle) throws Exception {
		...
		while (resultSet.next()) {
			String[] originalRow = { resultSet.getString(1), resultSet.getString(2), resultSet.getString(3),

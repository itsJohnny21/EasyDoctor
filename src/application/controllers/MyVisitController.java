...
public class MyVisitController extends Controller {
	...
	public void initialize() throws Exception {
		...
		fields.add(new String[] { "ID", String.valueOf(PatientPortalController.currentVisitID), "blank", "blank" }); // !
																														// FIX
																														// ME
		...
		Form visitForm = new Form(visitData, windowMaxWidth, 50, "-fx-background-color: #cc7878",
				"-fx-background-color: #cc7878", null);
		visitForm.generate();

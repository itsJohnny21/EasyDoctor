...
public class SignInController extends Controller {
	...
	@FXML
	public Hyperlink forgotUsernamePasswordHyperLink;
	@FXML
	...
	public void handleSignInButtonAction(ActionEvent event)
			throws SQLException, UnknownHostException, IOException, Exception {
		...
		// Attempt to sign in and load the appropriate view. If sign in failed,
	...
	@FXML
	public void handleForgotUsernamePasswordButtonAction(ActionEvent event) throws IOException, Exception {

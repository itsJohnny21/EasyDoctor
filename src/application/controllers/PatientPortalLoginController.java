...
public class PatientPortalLoginController {
	...
	@FXML public void handleLoginButtonAction(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/views/PatientPortalView.fxml"));
            Parent root = loader.load();
            ...
            App.stage.setTitle("Patient Portal");
            App.stage.show();
        } catch (IOException e) {
            e.printStackTrace();
        }

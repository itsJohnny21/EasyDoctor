...
public class PatientPortalController extends Controller {
	...
	@FXML
	public GridPane tabsPane;
	public AnchorPane currentTab;
	public Button currentButton;

	@FXML
	public AnchorPane myVisitsPane;
	@FXML
	public AnchorPane myInformationPane;
	@FXML
	public AnchorPane scheduleVisitPane;
	@FXML
	public AnchorPane inboxPane;
	@FXML
	public AnchorPane myPillsPane;
	@FXML
	public AnchorPane usernamePane;

	@FXML
	public Button myVisitsButton;
	@FXML
	public Button myInformationButton;
	@FXML
	public Button scheduleVisitButton;
	@FXML
	public Button inboxButton;
	@FXML
	public Button myPillsButton;
	@FXML
	...
	@FXML
	public ScrollPane myVisitsScrollPane;
	@FXML
	public ScrollPane myInformationScrollPane;
	@FXML
	public ScrollPane scheduleVisitScrollPane;
	@FXML
	public ScrollPane inboxScrollPane;
	@FXML
	public ScrollPane myPillsScrollPane;
	@FXML
	public ScrollPane usernameScrollPane;
	@FXML
	public ScrollPane signOutScrollPane;
	...
	public void initialize() throws Exception {
		...
		for (AnchorPane tab : new AnchorPane[] { myVisitsPane, myInformationPane, scheduleVisitPane, inboxPane,
				myPillsPane }) {
	...
	public void handleSignOutButtonAction(ActionEvent event)
			throws IOException, SQLException, UnknownHostException, Exception {
		Database.signOut();
		App.loadPage("SignInView", stage);
	}

	@FXML
	public void handleOnMousePressed(MouseEvent event) throws IOException, Exception {
	...
	@FXML
	public void handleOnMouseReleased(MouseEvent event) throws IOException, Exception {
		Button button = (Button) event.getSource();
	...
	@FXML
	public void handleOnMouseClickedVisits(MouseEvent event) throws IOException, Exception { // ! DELETE ME
		// App.loadPopup("PatientPortalVisitPopupView");
	}

	@FXML
	public void handleOnMouseEnteredVisits(MouseEvent event) { // ! DELETE ME
		GridPane gridPane = (GridPane) event.getSource();
		gridPane.setStyle("-fx-background-color: #ff6666");
	}

	@FXML
	public void handleOnMouseExitedVisits(MouseEvent event) { // ! DELETE ME
		GridPane gridPane = (GridPane) event.getSource();
		gridPane.setStyle("-fx-background-color: #ab5b67");
	}

	@FXML
	public void handleMyInformationButtonAction(ActionEvent event) throws IOException, Exception {
		Button button = (Button) event.getSource();
	...
	@FXML
	public void handleMyVisitsButtonAction(ActionEvent event) throws IOException, Exception {
		Button button = (Button) event.getSource();
	...
	@FXML
	public void handleScheduleVisitButtonAction(ActionEvent event) throws IOException, Exception {
		Button button = (Button) event.getSource();
		setCurrentTab(scheduleVisitPane, button);
	}

	@FXML
	public void handleScheduleVisitButtonAction2(ActionEvent event) throws IOException, Exception { // ! RENAME ME
		scheduleVisitButton.fire();
	}

	@FXML
	public void handleInboxButtonAction(ActionEvent event) throws IOException, Exception {
		Button button = (Button) event.getSource();
		setCurrentTab(inboxPane, button);
	}

	@FXML
	public void handleMyPillsButtonAction(ActionEvent event) throws IOException, Exception {
		Button button = (Button) event.getSource();
		setCurrentTab(myPillsPane, button);
	}

	@FXML
	public void handleUsernameButtonAction(ActionEvent event) throws IOException, Exception {
		Button button = (Button) event.getSource();
		setCurrentTab(inboxPane, button);
	}
	...
	public void loadContactInformationFor(int patientID, GridPane content) throws Exception {
		Form contactInformationForm = TableBuilder.generateContactInformationFormFor(patientID, "Contact Information",
				rowWidth, rowHeight, "-fx-background-color: #cc7878", "");
	...
	public void loadMedicalInformationFor(int patientID, GridPane content) throws Exception {
		Form medicalInformationForm = TableBuilder.generateMedicalInformationFormFor(patientID, "Medical Information",
				rowWidth, rowHeight, "-fx-background-color: #cc7878", "");
	...
	public void loadHealthConditionsFor(int patientID, GridPane content) throws Exception {
		Table healthConditionsTable = TableBuilder.generateHealthConditionsTableFor(patientID, "Health Conditions",
				rowWidth, rowHeight, "-fx-background-color: #cc7878", "");
	...
	public void loadVaccineRecordFor(int patientID, GridPane content) throws Exception {
		Table vaccineRecordTable = TableBuilder.generateVaccineRecordFor(patientID, "Vaccine Record", rowWidth,
				rowHeight, "-fx-background-color: #cc7878", "");
	...
	public void loadAllergiesFor(int patientID, GridPane content) throws Exception {
		Table allergiesTable = TableBuilder.generateAllergiesTableFor(patientID, "Allergies", rowWidth, rowHeight,
				"-fx-background-color: #cc7878", "");
	...
	public void loadSurgeriesFor(int patientID, GridPane content) throws Exception {
		Table surgeriesTable = TableBuilder.generateSurgeriesTableFor(patientID, "Surgeries", rowWidth, rowHeight,
				"-fx-background-color: #cc7878", "");
	...
	public void loadVisitsFor(int patientID, GridPane content) throws Exception {
		Table visitsTable = TableBuilder.generateVisitsTableFor(patientID, "Visits", rowWidth, rowHeight,
				"-fx-background-color: #cc7878", "");
